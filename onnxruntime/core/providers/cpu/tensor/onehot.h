...
class OneHot final : public OpKernel {
 public:
  explicit OneHot(const OpKernelInfo& op_kernel_info) : OpKernel(op_kernel_info) {
    int64_t tmp_axis;
 ...
 private:
  ORT_DISALLOW_COPY_ASSIGNMENT_AND_MOVE(OneHot);
